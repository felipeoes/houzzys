...
/*
  Estrutura TypeScript utilizada para tipar os parâmetros dos filtros de propriedade.
  Desta forma, todas as vezes que a aplicação necessitar enviar os parâmetros dos filtros
  ao servidor poderá consultar os objetos oriundos dessa estrutura.
*/
